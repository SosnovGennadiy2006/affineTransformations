...
namespace CustomTitleBarTemplate.Views.CustomTitleBars
{
    public class WindowsTitleBar : UserControl
    {
        ...
        public WindowsTitleBar()
        {
            ...
            {
                setStyleButton = this.FindControl<Button>("SetStyleButton");
                ...
                setStyleIcon = this.FindControl<Image>("SetStyleIcon");
        ...
        private void SetTheme(object sender, Avalonia.Interactivity.RoutedEventArgs e)
        {
            if (isDarkTheme == false)
            {
                ...
                setStyleIcon.Source = new Bitmap("../../../Assets/Images/sun.png");
            ...
            else
            {
                ...
                setStyleIcon.Source = new Bitmap("../../../Assets/Images/moon.png");
                Cursor = new Cursor(StandardCursorType.Arrow);
                isDarkTheme = false;
            }
        }
